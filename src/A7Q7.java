...
/**
 *
 * Create a program that will determine all of the prime numbers between 2 and 1000 using a process called "The Sieve of Eratosthenes" 
 * 
 * A Sieve of Eratosthenes works in the following manner:
 * - Create a list of consecutive integers from 2 to n (sieve).
 ...
 *   itself in the list. These will be multiples of p (note that some of them may have already been marked).
 ...
 * - Use a boolean array to mark as true (it is a prime) or false(it is not a prime). 
 * - The index of the array will correspond to the number you are investigating as a prime (i.e., the spot 5 in the boolean array would determine if 5 was prime or not).
 *
 * @author richj0985
 */
public class A7Q7 {
